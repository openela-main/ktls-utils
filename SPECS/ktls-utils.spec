...
* Thu Feb 19 2026 Scott Mayhew <smayhew@redhat.com> - 1.2.1-3
- tlshd: Send fatal alert to client when there are server config issues

* Wed Sep 17 2025 Scott Mayhew <smayhew@redhat.com> - 1.2.1-2
- Add support for ML-DSA certificates (RHEL-105441)

* Thu Aug 21 2025 Scott Mayhew <smayhew@redhat.com> - 1.2.1-1
